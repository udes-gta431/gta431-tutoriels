...
- Personne étudiante : Tomassina Bolvari-Bergeron
- CIP UdeS : bolt2701
- ID GitHub : TomassinaBB
- Thème du tutoriel : Jupyter Notebook et PyCharm
- URL du tutoriel : https://github.com/TomassinaBB/Jupyter-Notebook-et-PyCharm-Comparaison-et-Utilisation
...
- [X] O2 - La ou les compétences à acquérir sont clairement énoncées dès le début du tutoriel, mais ne sont pas réitérées tout au long du tutoriel.
...
- Le tutoriel est pertinent et intéressant. Il met en opposition deux environnements de manipulation de données d'affaires, mais il n'est pas toujours clair pourquoi on compare les deux. De plus, la vision est plus nuancée puisqu'on peut démarrer un kernel Python pour Jupyter Notebook dans PyCharm. Il serait intéressant d'illustrer les environnements plutôt que seulement les décrire. Néanmoins, ce tutoriel nous rapproche d'une meilleure compréhension des manipulations de données d'affaires. Félicitations pour ce travail bien mené.
- Il n'est pas toujours clair pourquoi il est nécessaire de comparer les deux environnements cités. Est-ce qu'on se situe dans un contexte d'utilisateur, de gestionnaire de l'environnement informatique ou de gestionnaire ? Il serait intéressant de préciser le contexte pour mieux comprendre les décisions à prendre et leurs impacts en contexte d'affaires.
- Les explications sont intéressantes, mais assez techniques. L'utilisation de figures est utile pour soutenir les propos.
- À l'utilisation de l'intelligence artificielle, ce qui est présumée ici, il est important de réduire la redondance dans un texte si court. 
- Le tutoriel offre une certaine synthèse, notamment en ce qui a trait à la comparaison des deux environnements, mais il serait intéressant de présenter plus systémqatiquement les apprentissages pour faciliter la révision et assurer la complétude du propos. 
- Le format Markdown est bien utilisé tant pour les rubriques que les exemples.
- Des coquilles persistent dans le texte, ex. `Foctionnement de l'environnement`... (Foctionnement).
